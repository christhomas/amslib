...
class Amslib_Translator_File extends Amslib_Translator
{
	...
	protected $__indexNormalLen;

	//	Length of the missing index in the dictionary
	protected $__indexMissingLen;
	...
	protected function __createNewIndex($file,$handle)
	{
		$d = array(
			"file"			=>	$file,
			"handle"		=>	$handle,
	...
	protected function __updateTranslation($input,$translation,&$index)
	{
		$key = substr($input,0,1);
		$index["write"] = true;
	...
	protected function __updateDatabase($key,$input,$translation)
	{
	...
	protected function __updateIndex(&$index,$key,$input,$translation,$copyOnChange)
	{
	...
	*/
	...
	protected function __getFileLength($handle)
	{
		$length = 0;
	...
	protected function __readDatabase($database,$force=false,$readAll=false)
	{
	...
	protected function __writeDatabase(&$dict)
	{
	...
	protected function __readDictionary(&$dict,$dictionary)
	{
	...
	protected function __readIndex(&$index,$directory,$keyLength,&$offset)
	{
	...
	protected function __writeDictionary(&$index,$numBytes)
	{
	...
	protected function __writeIndex($key,$handle,$start,$length)
	{
	...
	protected function __readSingleBlock($key,&$dict)
	{
		$dictKey = NULL;
	...
	protected function __readMultipleBlock($key)
	{
	...
	protected function __writeNormalBlock($key,$handle,&$dict)
	{
		$strings = array();
	...
	protected function __writeMissingBlock($key,$handle,&$dict)
	{
		return $this->__writeBlock($this->__tr[$key],$handle,$dict);
	}

	protected function __writeBlock($strings,$handle,&$dict)
	{
