...
class AntimatterTranslator
{
	...
	function AntimatterTranslator($database=NULL,$immediateClose=false)
	{
		// TODO: Throw an exception instead, it's better
		if(AntimatterTranslator::$interfaceType == false) die("AntimatterTranslator requires an interface type to continue");

		switch(AntimatterTranslator::$interfaceType){
			case "database":{
				$this->__accessLayer = new AntimatterTranslator_DatabaseInterface($database,$immediateClose);
			}break;

			case "file":{
				$this->__accessLayer = new AntimatterTranslator_FileInterface($database,$immediateClose);
			}
		};
	}
...
class AntimatterTranslator_BaseAccessLayer
{
	function AntimatterTranslator_BaseAccessLayer()
	{

	}
}

class AntimatterTranslator_FileInterface extends AntimatterTranslator_BaseAccessLayer
{
	...
	function AntimatterTranslator_FileInterface($database=NULL,$immediateClose=false)
	{
		parent::AntimatterTranslator_BaseAccessLayer();
...
class AntimatterTranslator_DatabaseInterface extends AntimatterTranslator_BaseAccessLayer
{
	var $database;

	function AntimatterTranslator_DatabaseInterface()
	{
		parent::AntimatterTranslator_BaseAccessLayer();
