;(function(window, document, Darkroom, fabric) {
  ...
  Darkroom.plugins['crop'] = Darkroom.Plugin.extend({
    ...
    {
        this.darkroom.dispatchEvent(eventName);
        this.darkroom.trigger("darkroom:"+eventName);
    },
    ...
    initialize: function InitDarkroomCropPlugin() {
      ...
      this.darkroom.trigger("darkroom:crop:init");
    },
    ...
    onMouseDown: function(event) {
      ...
      this.darkroom.trigger("darkroom:crop:start",this.cropZone.getWidth(),this.cropZone.getHeight());
    },
    ...
    onMouseUp: function(event) {
      ...
      this.darkroom.trigger("darkroom:crop:stop",this.cropZone.getWidth(),this.cropZone.getHeight());
    },
    ...
    cropCurrentZone: function() {
      ...
      image.onload = function() {
        ...
        darkroom.trigger("darkroom:crop:complete",width,height);
      };
    ...
    releaseFocus: function() {
      ...
      this.darkroom.trigger("darkroom:crop:destroy");
    },
